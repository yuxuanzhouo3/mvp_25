...
export function RoleClassification({ userSkills, role, score, onUpgrade }: RoleClassificationProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Upgrade CTA */}
      <Card className="bg-gradient-to-r from-yellow-600/20 to-orange-600/20 border-yellow-500/30 p-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-yellow-200 mb-4">基于你的技能评估结果，AI将为你生成专属的学习计划和职业发展建议</p>
            <div className="flex flex-wrap gap-2">
              <Badge className="bg-yellow-600/30 text-yellow-200">🧠 AI路径规划</Badge>
              <Badge className="bg-yellow-600/30 text-yellow-200">📅 每日学习计划</Badge>
              <Badge className="bg-yellow-600/30 text-yellow-200">📊 进度追踪</Badge>
              <Badge className="bg-yellow-600/30 text-yellow-200">🎯 目标导向</Badge>
            </div>
          </div>
          <Button
            onClick={onUpgrade}
